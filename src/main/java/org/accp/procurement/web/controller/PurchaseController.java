...
public class PurchaseController {
     ...
     * @return int
     */
    @RequestMapping("/updatePurchaseAndPurchaseDetail")
    public Integer updatePurchaseAndPurchaseDetail(PurchaseDto purchaseDto) {
        return this.purchaseService.updatePurchaseAndPurchaseDetail(purchaseDto);
    }
     ...
     * @return List<Purchase>
     */
    @RequestMapping("/selectQualityCheck")
    public List<Purchase> selectQualityCheck() {
        return this.purchaseService.selectQualityCheck();
    }
}